...
void u8g_sdl_init(void)
{
  ...
  u8g_sdl_color[2] = SDL_MapRGB( u8g_sdl_screen->format, 35, 67, 63 );
  u8g_sdl_color[1] = SDL_MapRGB( u8g_sdl_screen->format, 70, 134, 126);
  u8g_sdl_color[0] = SDL_MapRGB( u8g_sdl_screen->format, 140, 201, 189);
